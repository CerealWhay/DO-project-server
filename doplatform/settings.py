...
# Build paths inside the project like this https://www.pythonanywhere.com/user/xojiogel: BASE_DIR / 'subdir'.
...
WSGI_APPLICATION = 'doplatform.wsgi.application'
